  ...
  return (
    ...
    <>
     <tr >
                    ...
                    <td><button type="button" class="btn btn-success btn-sm" onClick={()=>handleApprove()}>Approve</button>
                        
                    </td>
                    <td><button type="button" className='btn btn-info btn-sm' onClick={()=>pdf()}>Generate PDF</button></td>
                </tr></>
  )
}
