...
//   },[uid])
  ...
  const handleDeleteData=async(id)=>{
    ...
    if(conf){
        ...
        try{
            const res = await axios.get(`/allBillCategory/${id}`)
  ...
  const handleSubmit=async(event)=>{
        ...
        try{
          const res = await axios.put(`/allBillCategory/${uid}`, dataForUpdate );
  ...
  const handleInputChange = (event) => {
    ...
    setAllData((prevBillCategory) => ({ ...prevBillCategory, [name]: value }));
};
